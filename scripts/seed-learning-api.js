...
async function seedLearningData() {
  try {
    ...
    // Module 1 Lessons
    const lesson1_1 = await createLesson(module1Id, {
...
- Comprehensive audit trail`,
    ...
    const lesson1_2 = await createLesson(module1Id, {
...
- Performance Metrics: Your productivity statistics`,
    ...
    const module2Response = await fetch(`${API_BASE}/modules`, {
      method: 'POST',
    ...
    if (!module2Response.ok) throw new Error('Failed to create Module 2');
    const module2Data = await module2Response.json();
    const module2Id = module2Data.data._id;
    console.log('Created Module 2:', module2Id);

    await createLesson(module2Id, {
...
3. Staff Review
   ...
   - Submits for reviewer approval`,
    ...
    const module3Response = await fetch(`${API_BASE}/modules`, {
      method: 'POST',
      headers: { 'Content-Type': 'application/json' },
      body: JSON.stringify({
        applicationId,
    ...
    if (!module3Response.ok) throw new Error('Failed to create Module 3');
    const module3Data = await module3Response.json();
    const module3Id = module3Data.data._id;
    console.log('Created Module 3:', module3Id);

    await createLesson(module3Id, {
...
- Process standardization`,
    ...
    const module4Response = await fetch(`${API_BASE}/modules`, {
      method: 'POST',
      headers: { 'Content-Type': 'application/json' },
      body: JSON.stringify({
        applicationId,
    ...
    if (!module4Response.ok) throw new Error('Failed to create Module 4');
    const module4Data = await module4Response.json();
    const module4Id = module4Data.data._id;
    console.log('Created Module 4:', module4Id);

    await createLesson(module4Id, {
...
- Run diagnostics regularly`,
    ...
    const module5Response = await fetch(`${API_BASE}/modules`, {
      method: 'POST',
      headers: { 'Content-Type': 'application/json' },
      body: JSON.stringify({
        applicationId,
    ...
    if (!module5Response.ok) throw new Error('Failed to create Module 5');
    const module5Data = await module5Response.json();
    const module5Id = module5Data.data._id;
    console.log('Created Module 5:', module5Id);

    await createLesson(module5Id, {
